# nix run github:pjones/plasma-manager | xclip -selection c
{
  programs.plasma = {
    ...
    configFile = {
      ...
      "kcminputrc"."Libinput.1241.41619.OBINS OBINS\nAnnePro2 Mouse"."PointerAccelerationProfile" = 1;
      ...
      "khotkeysrc"."General.$i"."AccentColor\x5b$d\x5d[$i]" = "";
      ...
      "khotkeysrc"."General.$i"."LastUsedCustomAccentColor\x5b$d\x5d[$i]" = "";
      ...
      "khotkeysrc"."KScreen"."XwaylandClientsScale\x5b$d\x5d" = "";
      ...
      "khotkeysrc"."Shortcuts"."Reload\x5b$d\x5d" = "";
      ...
      "khotkeysrc"."WM.$i"."frame\x5b$d\x5d[$i]" = "";
      ...
      "khotkeysrc"."WM.$i"."inactiveFrame\x5b$d\x5d[$i]" = "";
      ...
      "kwinrc"."Desktops"."Id_1" = "8b9ea9d1-baf7-4695-bf03-d21fbd9eee73";
      "kwinrc"."Desktops"."Id_2" = "1ac59358-7c29-4670-8759-cc9d19c319ff";
      "kwinrc"."Desktops"."Id_3" = "24f90907-195f-40a8-8b74-73e6ed2e4595";
      "kwinrc"."Desktops"."Id_4" = "520276da-cbce-44fd-9693-415b4f411755";
      "kwinrc"."Desktops"."Name_1" = "Desktop 8";
      "kwinrc"."Desktops"."Name_2" = "Desktop 9";
      "kwinrc"."Desktops"."Name_3" = "Desktop 10";
      "kwinrc"."Desktops"."Name_4" = "Desktop 10";
      ...
      "kwinrc"."Script-bismuth"."floatingClass" = "yakuake,spectacle,Conky,zoom,tdrop_terminal,copyq,Steam,lutris, steam,steam_app.*, Steam,Warframe,lutris,Riot Client Main,League of Legends, weixin, .scrcpy-wrapped,zenity,org.kde.polkit-kde-authentication-agent-1";
      ...
      "kwinrc"."Xwayland"."Scale" = 1.250000;
      ...
      "kwinrulesrc"."2"."opacityactive" = 92;
      ...
      "kwinrulesrc"."48304a6e-f9b6-4980-b37e-174d343b57ac"."opacityactive" = 92;
      ...
      "kwinrulesrc"."General"."rules" = "1,48304a6e-f9b6-4980-b37e-174d343b57ac,43d11804-f330-4d9f-aca2-d51617de4867";
      ...
      "plasmarc"."Wallpapers"."usersWallpapers" = "//home/i.want.to.believe/git.workspaces/dotfiles.workspaces/devos/arts/wallpapers/catppuccin_2.png";
